...
// copy from https://github.com/gamerpuppy/sts_lightspeed/blob/master/include/game/Random.h

#ifndef SEED_SEARCH_STS_RANDOM_H
#define SEED_SEARCH_STS_RANDOM_H
...
#endif //SEED_SEARCH_STS_RANDOM_H
